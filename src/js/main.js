...
const scrollAnimation = () => {
	if (window.scrollY > 5228 && window.scrollY < 5898) {
		offerBoxOne.classList.add('activeScrollAnimation')
	}

	if (window.scrollY > 5899) {
		offerBoxTwo.classList.add('activeScrollAnimation')
	}

	if (window.scrollY > 6528) {
		offerBoxThree.classList.add('activeScrollAnimation')
	}
}
//addEventListener
